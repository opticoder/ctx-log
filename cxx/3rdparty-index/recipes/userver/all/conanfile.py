# ORIGIN: https://github.com/conan-io/conan-center-index/pull/20712
import os
...
class UserverConan(ConanFile):
    ...
    def generate(self):
        ...
        tool_ch.preprocessor_definitions["BOOST_NO_CXX98_FUNCTION_BASE"] = "1"
    ...
    def package_info(self):
        ...
        self.cpp_info.components['universal'].defines.append('BOOST_NO_CXX98_FUNCTION_BASE')
